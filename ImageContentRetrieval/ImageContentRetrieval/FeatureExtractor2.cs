 ...
 * 
 * 本代码适用于
 * TensorFlow.NET 0.60.4
 * SciSharp.TensorFlow.Redist 2.6.0
 * 
 */
...
//                var bottleneck_data = session.run(bottleneck, (image, new Tensor(image_data, null, TF_DataType.TF_STRING)));
